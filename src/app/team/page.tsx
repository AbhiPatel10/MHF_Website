...
export default function TeamPage() {
  const president = {
    ...
    description: 'Hardiksinh Chudasama is a dynamic leader committed to spreading happiness and bringing positive change to society. With a strong background in social service, professional expertise as a Project Manager in an IT company, and a passion for writing, public speaking, and anchoring, he has dedicated his life to empowering communities. His journey is a testament to how one individual can inspire many to make a difference.',
    social: {
      twitter: '#',
      linkedin: '#'
    }
  ...
  const vicePresident = {
    ...
    aiHint: 'indian man portrait',
    description: 'Yashwant Ahir is a dedicated professional with a strong background in community service. As Vice President, he focuses on enhancing organizational effectiveness and fostering collaboration among team members.',
    social: {
      twitter: '#',
      linkedin: '#'
    }
        ...
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-muted-foreground">
              The heart of our organization is our passionate and dedicated team of members who work tirelessly to make a difference.
            </p>
          </div>

          {president && (
            <div className="mt-20">
              <Card className="grid md:grid-cols-5 gap-8 p-8 border-0 shadow-none">
                ...
                <div className="md:col-span-3 flex flex-col justify-center">
                  <h2 className="text-3xl font-bold font-headline">{president.name}</h2>
                  <p className="text-primary font-semibold mt-1">{president.role}</p>
            ...
            <div className="mt-20">
              <Card className="grid md:grid-cols-5 gap-8 p-8 border-0 shadow-none">
                <div className="md:col-span-3 flex flex-col justify-center text-right">
                  <h2 className="text-3xl font-bold font-headline">{vicePresident.name}</h2>
                  <p className="text-primary font-semibold mt-1">{vicePresident.role}</p>
                  <p className="text-muted-foreground mt-4 text-lg leading-relaxed text-justify">
          ...
          <div className="mt-24">
            <div className="text-center mb-12">
              ...
              <p className="mt-2 text-lg text-muted-foreground">The dedicated team that drives our success.</p>
            </div>
          ...
          <div className="mt-24">
            <div className="text-center mb-12">
              ...
              <p className="mt-2 text-lg text-muted-foreground">The dedicated individuals who form the backbone of our organization.</p>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8">
              {loading
                ? renderSkeletons(5)
